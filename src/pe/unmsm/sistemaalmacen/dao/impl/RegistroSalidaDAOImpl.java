...
import pe.unmsm.sistemaalmacen.daou.RegistroSalidaDAO;
...
//PRUEBA DE RETURN
        ...
        SalidaEntrada.insertarAlFinal(new RegistroEntrada(1, new Date(1,2,3), "Usuario1", "Cliente1",listaSalida,"Observacion 1", 1234f,  12312.0f, 123123.0f));
        ...
        SalidaEntrada.insertarAlFinal(new RegistroEntrada(2, new Date(4,5,6), "Administrador2", "Cliente2",listaSalida2,"Observacion 2", 221234f,  123.0f, 3123.0f));
